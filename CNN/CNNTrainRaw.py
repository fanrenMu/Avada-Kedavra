...
# 定义目录路径
DEF_SAVE_TO_PATH = './TraningData_1_12'
...
def train(x_train, y_train, x_test, y_test, input_shape=(DEF_N_ROWS, len(DEF_COLUMNS)), num_classes=len(motion_names), batch_size=DEF_BATCH_SIZE, epochs=DEF_NUM_EPOCH):
